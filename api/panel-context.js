...
export default async function handler(request, response) {
  ...
  try {
    ...
    const requestedAllowed = ["/panel/egitmen/profil", "/panel/egitmen/egitimlerim", "/panel/egitmen/sunumlarim"].includes(requestedPanel) ? context.roles.includes("TRAINER") : (context.destinations?.includes(requestedPanel) || context.destination === requestedPanel);
