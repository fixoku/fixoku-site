...
const { db } = createDb();
const authRateLimit = { enabled: true, storage: "database" as const, window: 10, max: 100, customRules: { "/sign-in/email": { window: 900, max: 5 }, "/sign-up/email": { window: 3600, max: 1 } } };
