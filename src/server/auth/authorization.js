...
export const ROLE_PERMISSIONS = Object.freeze({ SUPER_ADMIN: ["user.manage", "membership.manage", "audit.read"], TRAINER: ["trainer.read", "student.read", "schedule.read", "earning.read", "content.read", "qualification.read"], STUDENT: ["student.read", "enrollment.read", "content.read", "schedule.read"], GUARDIAN: ["student.read", "enrollment.read", "content.read", "schedule.read"] });
