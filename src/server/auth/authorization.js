...
export const ROLE_PERMISSIONS = Object.freeze({ SUPER_ADMIN: ["user.manage", "membership.manage", "audit.read", "trainer.profile.read", "trainer.profile.update", "trainer.training.read", "trainer.presentation.read"], TRAINER: ["trainer.read", "trainer.profile.read", "trainer.profile.update", "trainer.training.read", "trainer.presentation.read", "student.read", "schedule.read", "earning.read", "content.read", "qualification.read"], STUDENT: ["student.read", "enrollment.read", "content.read", "schedule.read"], GUARDIAN: ["student.read", "enrollment.read", "content.read", "schedule.read"] });
